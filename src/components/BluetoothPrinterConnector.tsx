...
import { 
  ...
  Download, Upload, CheckCircle2, AlertTriangle, RefreshCw, Smartphone 
} from 'lucide-react';
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" id="printer-connector-container">
      ...
      <div className="space-y-6">
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm" id="printer-device-card">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h2 className="text-lg font-semibold text-slate-800">Printer Thermal Bluetooth (ESC/POS)</h2>
          </div>
          ...
          {activePrinter ? (
            <div className="bg-indigo-50/30 border border-indigo-100/50 p-5 rounded-2xl flex flex-col items-center text-center space-y-3" id="printer-status-connected">
              ...
              <div>
                ...
                <p className="text-xs text-indigo-600 font-mono mt-1 font-semibold">{activePrinter.name}</p>
              </div>
            ...
            <div className="bg-slate-50 border border-slate-150 p-5 rounded-2xl flex flex-col items-center text-center space-y-4" id="printer-status-disconnected">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1 max-w-[280px]">
                  Hubungkan ke printer thermal 58mm Bluetooth Anda langsung dari browser untuk dapat mencetak struk belanja.
                </p>
              </div>
          ...
          {/* Bluetooth Troubleshooting / Browser Notice */}
          <div className="mt-5 p-4 bg-amber-50/50 border border-amber-100 rounded-xl space-y-2.5 text-xs text-slate-600" id="printer-troubleshoot-guide">
            <h5 className="font-bold text-slate-800 flex items-center gap-1.5">
              ...
              <span>Panduan Koneksi Printer Bluetooth</span>
            </h5>
            <ul className="list-disc pl-4 space-y-1.5 leading-relaxed">
              <li>
                <strong>Buka di Tab Baru:</strong> Jika Anda berada di dalam editor AI Studio, silakan klik tombol <strong className="text-indigo-600 font-bold">Open in new tab</strong> di bagian atas kanan preview, karena browser melarang Bluetooth di dalam Iframe.
              </li>
              <li>
                <strong>Browser yang Didukung:</strong> Gunakan Google Chrome, Microsoft Edge, atau Opera versi terbaru (baik di Laptop, PC, maupun Android). iOS Safari belum mendukung Bluetooth Web.
              </li>
              <li>
                <strong>Nyalakan Fitur:</strong> Pastikan Bluetooth di perangkat Anda telah diaktifkan, dan layanan Lokasi (GPS) dinyalakan untuk memberikan izin scan BLE.
              </li>
              <li>
                <strong>Jenis Printer:</strong> Printer thermal berukuran lebar 58mm standar kasir (seperti Panda, POS, MPT) sangat cocok digunakan.
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm h-fit space-y-5" id="warung-settings-card">
        ...
        {/* Demo smartphone mock layout showing mock Bluetooth print sequence */}
        <div className="p-4 bg-slate-50 border border-slate-100 rounded-xl flex items-start gap-3" id="mock-ble-diagram">
          <Smartphone className="w-10 h-10 text-indigo-600 shrink-0 mt-0.5" />
          <div className="space-y-1 text-xs">
            <h4 className="font-bold text-slate-700">Integrasi Web Bluetooth Murni</h4>
            <p className="text-slate-500 leading-relaxed">
              Aplikasi ini mengimplementasikan <strong className="font-semibold text-indigo-600">Web Bluetooth GATT Service API</strong> langsung. Data transaksi dikompresi menjadi ESC/POS bytes biner, lalu dikirim via gelombang Bluetooth dengan chunk buffer 20-byte agar kompatibel dengan printer murah sekalipun.
            </p>
          </div>
        </div>
      </div>
